...
export class ClaimMetadata {
    ...
    set mandatory(value: boolean | null | undefined);
    path: ClaimPath;
...
export class Disclosure {
     ...
     */
    static parse(s: string): Disclosure;
    toString(): string;
...
export class IdentityClient {
     ...
     */
    publishDidUpdate(document: IotaDocument): Promise<TransactionBuilder<Transaction<IotaDocument>>>;
...
export class IdentityClientReadOnly {
     ...
     */
    static create(iota_client: IotaClient, custom_package_id?: string | null): Promise<IdentityClientReadOnly>;
    /**
...
export class KeyBindingJwtBuilder {
    ...
    finish(sd_jwt: SdJwt, alg: string, signer: JwsSigner): Promise<KeyBindingJwt>;
    /**
     ...
     */
    header(key: string, value: any): KeyBindingJwtBuilder;
    /**
     * Sets the JWT headers.
     */
    headers(headers: object): KeyBindingJwtBuilder;
...
export class SdJwt {
     ...
     */
    attachKeyBindingJwt(kb_jwt: KeyBindingJwt): void;
    /**
...
export class SdJwtBuilder {
     ...
     */
    finish(signer: JwsSigner, alg: string): Promise<SdJwt>;
    /**
     * Sets a single JWT header by its key and value.
     */
    header(key: string, value: any): SdJwtBuilder;
    /**
     * Sets the JWT header.
     * ## Notes
     ...
     */
    headers(headers: object): SdJwtBuilder;
    /**
...
export class SdJwtCredentialValidator {
     ...
     * algorithms will be used.
     */
    constructor(hasher: Hasher, signatureVerifier?: IJwsVerifier | null);
    /**
     ...
     * An error is returned whenever a validated condition is not satisfied.
     */
    validateCredential(sd_jwt: SdJwt, issuer: CoreDocument | IToCoreDocument, options: JwtCredentialValidationOptions): Credential;
    /**
     ...
     * An error is returned whenever a validated condition is not satisfied.
     */
    validateCredentialV2(sd_jwt: SdJwt, issuer: CoreDocument | IToCoreDocument, options: JwtCredentialValidationOptions): CredentialV2;
    /**
     ...
     */
    validateKeyBindingJwt(sd_jwt: SdJwt, holder: CoreDocument | IToCoreDocument, options: KeyBindingJwtValidationOptions): void;
    /**
     ...
     */
    verifySignature(credential: SdJwt, trustedIssuers: Array<CoreDocument | IToCoreDocument>, options: JwsVerificationOptions): void;
}
...
export class SdJwtPresentationBuilder {
     ...
     * omitted.
     */
    conceal_all(): SdJwtPresentationBuilder;
    /**
...
export class SdJwtVcBuilder {
     ...
     * Sets a single JWT header by its key and value.
     */
    header(key: string, value: any): SdJwtVcBuilder;
    /**
     * Sets the JWT header.
     * ## Notes
     * - if {@link SdJwtVcBuilder.header} is not called, the default header is used: ```json { "typ": "sd-jwt", "alg":
     ...
     * - `alg` is always replaced with the value passed to {@link SdJwtVcBuilder.finish}.
     */
    headers(headers: object): SdJwtVcBuilder;
    /**
...
export class SdJwtVcPresentationBuilder {
    ...
    conceal_all(): SdJwtVcPresentationBuilder;
    disclose(path: string): SdJwtVcPresentationBuilder;
...
export class StorageSigner {
     ...
     */
    static fromVmFragment(storage: Storage, document: CoreDocument | IToCoreDocument, fragment: string): Promise<StorageSigner>;
    iotaPublicKeyBytes(): Promise<Uint8Array>;
    keyId(): string;
...
export interface InitOutput {
    ...
    readonly __wbg_shorthanddidupdate_free: (a: number, b: number) => void;
    ...
    readonly identityclient_publishDidUpdate: (a: number, b: number) => any;
    ...
    readonly identityclientreadonly_create: (a: any, b: number, c: number) => any;
    ...
    readonly shorthanddidupdate_apply: (a: number, b: any, c: any) => any;
    readonly shorthanddidupdate_buildProgrammableTransaction: (a: number, b: any) => any;
    ...
    readonly __wbg_storagejwssigner_free: (a: number, b: number) => void;
    ...
    readonly storagejwssigner_sign: (a: number, b: any, c: any) => any;
    readonly storagesigner_asJwsSigner: (a: number) => number;
    readonly storagesigner_fromVmFragment: (a: number, b: any, c: number, d: number) => any;
    ...
    readonly storagesigner_publicJwk: (a: number) => number;
    ...
    readonly __wbg_get_claimmetadata_mandatory: (a: number) => number;
    ...
    readonly __wbg_get_disclosure_claimValue: (a: number) => any;
    ...
    readonly __wbg_set_claimmetadata_mandatory: (a: number, b: number) => void;
    ...
    readonly __wbg_set_disclosure_claimValue: (a: number, b: any) => void;
    ...
    readonly keybindingjwtbuilder_header: (a: number, b: number, c: number, d: any) => [number, number, number];
    readonly keybindingjwtbuilder_headers: (a: number, b: any) => [number, number, number];
    ...
    readonly sdjwtbuilder_header: (a: number, b: number, c: number, d: any) => [number, number, number];
    readonly sdjwtbuilder_headers: (a: number, b: any) => number;
    ...
    readonly __wbg_set_claimdisplay_locale: (a: number, b: number, c: number) => void;
    readonly __wbg_set_disclosure_salt: (a: number, b: number, c: number) => void;
    readonly __wbg_set_disclosure_claimName: (a: number, b: number, c: number) => void;
    ...
    readonly __wbg_get_disclosure_claimName: (a: number) => [number, number];
    ...
    readonly __wbg_get_claimdisplay_locale: (a: number) => [number, number];
    readonly __wbg_get_disclosure_salt: (a: number) => [number, number];
    ...
    readonly sdjwtcredentialvalidator_new: (a: any, b: number) => number;
    readonly sdjwtcredentialvalidator_validateCredential: (a: number, b: number, c: any, d: number) => [number, number, number];
    readonly sdjwtcredentialvalidator_validateCredentialV2: (a: number, b: number, c: any, d: number) => [number, number, number];
    readonly sdjwtcredentialvalidator_validateKeyBindingJwt: (a: number, b: number, c: any, d: number) => [number, number];
    readonly sdjwtcredentialvalidator_verifySignature: (a: number, b: number, c: any, d: number) => [number, number];
    ...
    readonly sdjwt_attachKeyBindingJwt: (a: number, b: number) => void;
    readonly sdjwt_claims: (a: number) => [number, number, number];
    readonly sdjwt_disclosures: (a: number) => [number, number];
    readonly sdjwt_headers: (a: number) => any;
    readonly sdjwt_intoDisclosedObject: (a: number) => [number, number, number];
    readonly sdjwt_parse: (a: number, b: number) => [number, number, number];
    readonly sdjwt_presentation: (a: number) => [number, number];
    readonly sdjwt_requiredKeyBind: (a: number) => any;
    readonly sdjwt_toJSON: (a: number) => any;
    readonly sdjwt_toString: (a: number) => any;
    readonly sdjwtpresentationbuilder_conceal: (a: number, b: number, c: number) => [number, number, number];
    readonly sdjwtpresentationbuilder_conceal_all: (a: number) => number;
    readonly sdjwtpresentationbuilder_disclose: (a: number, b: number, c: number) => [number, number, number];
    readonly sdjwtpresentationbuilder_finish: (a: number) => number;
    readonly sdjwtpresentationbuilder_new: (a: number, b: any) => [number, number, number];
    readonly sdjwtvc_asSdJwt: (a: number) => number;
    readonly sdjwtvc_attachKeyBindingJwt: (a: number, b: number) => void;
    ...
    readonly sdjwtvcbuilder_header: (a: number, b: number, c: number, d: any) => [number, number, number];
    readonly sdjwtvcbuilder_headers: (a: number, b: any) => number;
    ...
    readonly sdjwtvcpresentationbuilder_conceal_all: (a: number) => number;
    readonly sdjwtvcpresentationbuilder_disclose: (a: number, b: number, c: number) => [number, number, number];
    readonly sdjwtvcpresentationbuilder_finish: (a: number) => number;
    ...
    readonly wasm_bindgen__closure__destroy__hd6c6646ef500b6d7: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__h13e11ef673ad14d4: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h0387adeb3ec5c033: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__hc5786b2acf18cd71: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h75e3d6db65e70d2a: (a: number, b: number) => void;
