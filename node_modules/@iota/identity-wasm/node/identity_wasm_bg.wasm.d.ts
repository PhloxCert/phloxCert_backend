...
export const __wbg_shorthanddidupdate_free: (a: number, b: number) => void;
...
export const identityclient_publishDidUpdate: (a: number, b: number) => any;
...
export const identityclientreadonly_create: (a: any, b: number, c: number) => any;
...
export const shorthanddidupdate_apply: (a: number, b: any, c: any) => any;
export const shorthanddidupdate_buildProgrammableTransaction: (a: number, b: any) => any;
...
export const sdjwtcredentialvalidator_new: (a: any, b: number) => number;
export const sdjwtcredentialvalidator_validateCredential: (a: number, b: number, c: any, d: number) => [number, number, number];
export const sdjwtcredentialvalidator_validateCredentialV2: (a: number, b: number, c: any, d: number) => [number, number, number];
export const sdjwtcredentialvalidator_validateKeyBindingJwt: (a: number, b: number, c: any, d: number) => [number, number];
export const sdjwtcredentialvalidator_verifySignature: (a: number, b: number, c: any, d: number) => [number, number];
...
export const sdjwt_attachKeyBindingJwt: (a: number, b: number) => void;
export const sdjwt_claims: (a: number) => [number, number, number];
export const sdjwt_disclosures: (a: number) => [number, number];
export const sdjwt_headers: (a: number) => any;
export const sdjwt_intoDisclosedObject: (a: number) => [number, number, number];
export const sdjwt_parse: (a: number, b: number) => [number, number, number];
export const sdjwt_presentation: (a: number) => [number, number];
export const sdjwt_requiredKeyBind: (a: number) => any;
export const sdjwt_toJSON: (a: number) => any;
export const sdjwt_toString: (a: number) => any;
export const sdjwtpresentationbuilder_conceal: (a: number, b: number, c: number) => [number, number, number];
export const sdjwtpresentationbuilder_conceal_all: (a: number) => number;
export const sdjwtpresentationbuilder_disclose: (a: number, b: number, c: number) => [number, number, number];
export const sdjwtpresentationbuilder_finish: (a: number) => number;
...
export const sdjwtvc_attachKeyBindingJwt: (a: number, b: number) => void;
...
export const sdjwtvcbuilder_header: (a: number, b: number, c: number, d: any) => [number, number, number];
export const sdjwtvcbuilder_headers: (a: number, b: any) => number;
...
export const sdjwtvcpresentationbuilder_conceal_all: (a: number) => number;
export const sdjwtvcpresentationbuilder_disclose: (a: number, b: number, c: number) => [number, number, number];
export const sdjwtvcpresentationbuilder_finish: (a: number) => number;
...
export const __wbg_storagejwssigner_free: (a: number, b: number) => void;
...
export const storagejwssigner_sign: (a: number, b: any, c: any) => any;
export const storagesigner_asJwsSigner: (a: number) => number;
export const storagesigner_fromVmFragment: (a: number, b: any, c: number, d: number) => any;
...
export const storagesigner_publicJwk: (a: number) => number;
...
export const __wbg_get_claimdisplay_locale: (a: number) => [number, number];
export const __wbg_get_claimmetadata_display: (a: number) => [number, number];
export const __wbg_get_claimmetadata_mandatory: (a: number) => number;
...
export const __wbg_get_disclosure_claimValue: (a: number) => any;
...
export const __wbg_set_claimdisplay_locale: (a: number, b: number, c: number) => void;
export const __wbg_set_claimmetadata_display: (a: number, b: number, c: number) => void;
export const __wbg_set_claimmetadata_mandatory: (a: number, b: number) => void;
...
export const __wbg_set_disclosure_claimValue: (a: number, b: any) => void;
...
export const keybindingjwtbuilder_header: (a: number, b: number, c: number, d: any) => [number, number, number];
export const keybindingjwtbuilder_headers: (a: number, b: any) => [number, number, number];
...
export const sdjwtbuilder_header: (a: number, b: number, c: number, d: any) => [number, number, number];
export const sdjwtbuilder_headers: (a: number, b: any) => number;
...
export const __wbg_set_disclosure_salt: (a: number, b: number, c: number) => void;
...
export const __wbg_set_disclosure_claimName: (a: number, b: number, c: number) => void;
...
export const __wbg_get_disclosure_claimName: (a: number) => [number, number];
...
export const __wbg_get_disclosure_salt: (a: number) => [number, number];
...
export const wasm_bindgen__closure__destroy__hd6c6646ef500b6d7: (a: number, b: number) => void;
export const wasm_bindgen__closure__destroy__h13e11ef673ad14d4: (a: number, b: number) => void;
export const wasm_bindgen__convert__closures_____invoke__h0387adeb3ec5c033: (a: number, b: number, c: any, d: any) => void;
export const wasm_bindgen__convert__closures_____invoke__hc5786b2acf18cd71: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h75e3d6db65e70d2a: (a: number, b: number) => void;
