...
import { Borrow, ConfigChange, ControllerExecution, ControllerToken, OnChainIdentity, SendAction, UpdateDid } from "./identity_wasm.js";
export type Action = UpdateDid | SendAction | ConfigChange | Borrow | ControllerExecution;
export type ProposalOutput<A extends Action> = A extends UpdateDid ? void : A extends SendAction ? void : A extends ConfigChange ? void : A extends Borrow ? void : A extends ControllerExecution ? void : never;
...
export type SubAccessFn<Tx extends Transaction<unknown>> = (subIdentity: OnChainIdentity, token: ControllerToken) => Promise<Tx>;
declare module "./identity_wasm.js" {
    interface OnChainIdentity {
         ...
         */
        accessSubIdentity<Tx extends Transaction<unknown>>(controllerToken: ControllerToken, subIdentity: OnChainIdentity, subFn?: SubAccessFn<Tx>, expiration?: bigint): TransactionBuilder<Transaction<AccessSubIdentityProposal | Awaited<ReturnType<Tx["apply"]>>>>;
    }
    interface AccessSubIdentityProposal {
        /** Returns an executable transaction that consumes this proposal. */
        intoTx<Tx extends Transaction<unknown>>(identity: OnChainIdentity, identityToken: ControllerToken, subIdentity: OnChainIdentity, subAccessFn: SubAccessFn<Tx>): TransactionBuilder<Tx>;
    }
}
